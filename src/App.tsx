  ...
  return (
    <div className="container d-flex justify-content-center align-items-center vh-100">
      <div className="flex-column rounded border-2 p-4 bg-light shadow">
        <h1 className="text-center">store_775612559.aleo</h1>
...
const WalletToolBox = () => {
  const [selectedTransition, setSelectedTransition] = useState<string | null>("mint_public");
  ...
  return (
    <div className="mt-2 flex-column rounded border-2 p-4 bg-light shadow">
      <Button onClick={() => handleTransitionSelection("mint_token")}>Mint Token</Button>
      <Button onClick={() => handleTransitionSelection("add_item")}>Add Item</Button>
      <Button onClick={() => handleTransitionSelection("buy_item")}>Buy Item</Button>
      <Button onClick={() => handleTransitionSelection("check_mapping")}>Check Mapping</Button>
...
const TransitionComponent: React.FC<{ transition: string }> = ({ transition }) => {
  const program_name = "store_775612559.aleo";
